                ...
                children: <Widget>[
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text(userQuestion, style: TextStyle(fontSize: fontSize, color: Colors.teal[900])),
                    ),
                  ),
                  Container(
                    ...
                    child: Text(
                      userAnswer,
                      style: TextStyle(fontSize: fontSize, color: Colors.teal[900]),
                    ),
                  )
                ],
              ),
              ...
              itemBuilder: (BuildContext context, int index) {
                  ...
                  return MyButton(
                      buttonTapped: () {
                        if ((userQuestion.length + userAnswer.length) > 17) {
                          var temp = (userQuestion.length + userAnswer.length) - 17;
                          userQuestion += tempA;
                          setState(() {
                            userQuestion = userQuestion.substring(0, userQuestion.length - temp);
                          });
                        } else {
                          setState(() {
                            userQuestion += tempA;
                ...
                // Rest of the buttons
                  ...
                  return MyButton(
                        ...
                        if (userQuestion.length >= 17) {
                          setState(() {
                            ...
                            ScaffoldMessenger.of(context)
                                .showSnackBar(SnackBar(content: Text('Maximum number of digits (17) exceeded.')));
                          });
                        } else {
                          setState(() {
                      ...
                      buttonText: buttons[index],
                      color: isOperator(buttons[index]) ? Colors.teal[300] : Colors.teal,
                      textColor: Colors.white);
                }
              }),
        ],
                ...
                showDialog(
                    ...
                    builder: (_) => AlertDialog(
                          ...
                          content: SingleChildScrollView(
                            child: ListBody(
                              children: <Widget>[Text('Do you want to delete your history of calculations?')],
                            ),
                          ),
                          actions: <Widget>[
                            TextButton(
            ...
            itemBuilder: (context, index) {
              return Card(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ListTile(
                      title: Text(history[index] + ' = ' + answerHistory[index]),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
